 ...
 * are the entire argument this section makes.
 */
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:gap-16">
          <Reveal>
            ...
            <p className={`mt-4 max-w-xl ${lede}`}>
              Then you decide. You can write to any school on the list, including the ones we called a Reach.
          ...
          <Reveal delay={0.1}>
            <figure className="mx-auto w-full max-w-[560px]">
              <div className="oc-raised overflow-hidden rounded-card bg-card shadow-lift ring-1 ring-line">
                <Image
