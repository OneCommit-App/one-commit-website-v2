      ...
      <main className="px-4 pb-16 flex justify-center">
        <article className="w-full max-w-2xl prose-sm">
          ...
          {[
            ...
            { title: "How We Use Your Information", content: "Provide Our Core Service: Waitlist management; school matching; AI-assisted email drafting; communication tracking; subscription processing if paid plans become available.\n\nImprove Our Service: Aggregate analytics to improve matching; feature usage understanding; accuracy and performance improvements.\n\nCommunicate With You: Service updates, support responses, invite notices, and billing notices if paid plans become available.\n\nLegal and Safety: Compliance, fraud prevention, and enforcement of Terms." },
